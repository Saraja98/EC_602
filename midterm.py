...
def ship_size(s):
  ...
  a=allcol
  b=col1
  m=[i for i, item in enumerate(a) if item in b]


  if not col1 in allcol:
      return("False")
  if not col2 in allcol:
      return("False")
  if not row1 in allrow:
      return("False")
  if not row2 in allrow:
      return("False")
  if col1 != col2 and row1 != row2: #checking to see if both rows and columns are different
      return("False")
